...
export const DEFAULT_WEBEX_MCP_SERVER_NAME = "Webex-suite";
export const DEFAULT_WEBEX_MCP_SERVER_URL = "https://mcp.webexapis.com/mcp/webex-suite";
...
export function getWebexSuiteOAuthSettings(env = process.env) {
  ...
  return {
    ...
    tokenStorePath,
    mcpServerName:
      clean(env.CODEX_WEBEX_MCP_SERVER_NAME) || DEFAULT_WEBEX_MCP_SERVER_NAME,
    mcpServerUrl:
      clean(env.CODEX_WEBEX_MCP_SERVER_URL) || DEFAULT_WEBEX_MCP_SERVER_URL,
  };
}
